...
public class Test04 extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// front에서 전송되어온 mid와 pwd값을 DB에 저장된 mid/pwd와 비교 후 처리
...
//		RequestDispatcher dispatcher = request.getRequestDispatcher(request.getContextPath()+"/study/0223/test04Ok.jsp?mid="+mid+"&pwd="+pwd);
