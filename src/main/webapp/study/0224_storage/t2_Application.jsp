...
<div class="container">
	...
	<form name="myform" method="post" action="t2_ApplicationSave.jsp">
		<table class="table tbale-bordered text-center">
			...
			<tr>
				<td colspan="2">
					<button type="submit" class="btn btn-success btn-sm me-2">Application저장</button>
					<a href="t2_ApplicationCheck.jsp" class="btn btn-primary btn-sm me-2">Application확인</a>
					<input  type="button" value="Application부분삭제" onclick="location.href='t2_ApplicationDelete.jsp'" class="btn btn-danger btn-sm me-2"/>
				</td>
			</tr>
		</table>
	</form>
