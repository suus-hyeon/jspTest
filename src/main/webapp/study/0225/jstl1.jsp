...
<div class="container">
	...
	su2변수를 선언 후 초기값으로 100을 할당? <c:set var="su1" value="100" /><br/>
	...
	2. su3 != su4 : <c:if test="${su3 != su4}">su3와 su4는 같지 않다.</c:if><br/>
	...
	11. su4 &gt; su5 : <c:if test="${su4 gt su5}">su4가 su5보다 크다.</c:if><br/>
	12. su4 &ge; su5 : <c:if test="${su4 ge su5}">su4가 su5보다 크거나 같다.</c:if><br/>
	<br/>
	13.URL에 QueryString방식으로 값이 전송될때의 계산(주소?jum=75)<br/>
...
%>
	...
	<br/>
	<div>첫번째 카드는 노란색으로, 마지막 카드는 빨간색 출력</div>
	<c:forEach var="card" items="${cards}" varStatus="st">
